...
public class Day03_Checkbox {
    WebDriver driver;// instance variable yaptik.static olsa her deger atamada degsisirdi bu bilgi burda isimize yaradi. degeri null yaptik asagilarda kullanablrz
    @Before
    public void setUp(){
...
//        Then click on checkbox1 if box is not selected
        if (!checkbox1.isSelected()){ //checkbox 1 select degilse (!) click yap
            checkbox1.click();
        }
