...
//        Verify the Bolded text contains “Editor”
        String pageHeader = driver.findElement(By.xpath("//h3[.='An iFrame containing the TinyMCE WYSIWYG Editor']")).getText(); //@attribute yerine . dot koyduk cunku attribete yokti ve . attribete yi temsil eder
        Assert.assertTrue(pageHeader.contains("Editor"));
//       // . dot @attribete yerine gecer / * asterix ise tum tagler terine gecer
//        Locate the text box
